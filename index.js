const  XBOT = 'TATSUMAKI BOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/okalji'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+628990900495'; // Nomor whatsapplu cok
const aktif = 'SORE'; // Kapan bot lu aktif
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Alji\n' // full name
            + 'ORG:Owner  TATSUMAKI BOT;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=628990900495:+62 899-0900-495\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.sendMessage(id, 'Owner TATSUMAKI BOT wa.me/+628990900495' ,MessageType.text);
}
else if (text == 'alji'){
conn.sendMessage(id, 'Aku BOT nya TATSUMAKI BOT' ,MessageType.text);
}
else if (text == 'audio'){
